...
const MANIFEST = [
  ...
  { slug: "wee-willie-winkie", title: "Wee Willie Winkie", author: "Traditional", kind: "rhyme", src: "mg", heading: "WEE WILLIE WINKIE" },
  { slug: "see-saw-margery-daw", title: "See-Saw, Margery Daw", author: "Traditional", kind: "rhyme", src: "mg", heading: "SEE-SAW" },
  { slug: "one-two-buckle-my-shoe", title: "One, Two, Buckle My Shoe", author: "Traditional", kind: "rhyme", src: "mg", heading: "ONE, TWO, BUCKLE MY SHOE" },
  { slug: "old-king-cole", title: "Old King Cole", author: "Traditional", kind: "rhyme", src: "mg", heading: "OLD KING COLE" },
  { slug: "pease-porridge", title: "Pease Porridge Hot", author: "Traditional", kind: "rhyme", src: "mg", heading: "PEASE PORRIDGE" },
  { slug: "to-market", title: "To Market, to Market", author: "Traditional", kind: "rhyme", src: "mg", heading: "TO MARKET" },
  { slug: "come-out-to-play", title: "Girls and Boys, Come Out to Play", author: "Traditional", kind: "rhyme", src: "mg", heading: "COME OUT TO PLAY" },
  { slug: "going-to-st-ives", title: "As I Was Going to St. Ives", author: "Traditional", kind: "rhyme", src: "mg", heading: "GOING TO ST. IVES" },
  { slug: "the-swing", title: "The Swing", author: "Robert Louis Stevenson", kind: "poem", src: "rls", heading: "THE SWING" },
  { slug: "my-shadow", title: "My Shadow", author: "Robert Louis Stevenson", kind: "poem", src: "rls", heading: "MY SHADOW" },
  { slug: "the-cow", title: "The Cow", author: "Robert Louis Stevenson", kind: "poem", src: "rls", heading: "THE COW" },
  { slug: "the-moon", title: "The Moon", author: "Robert Louis Stevenson", kind: "poem", src: "rls", heading: "THE MOON" },
  { slug: "bed-in-summer", title: "Bed in Summer", author: "Robert Louis Stevenson", kind: "poem", src: "rls", heading: "BED IN SUMMER" },
  { slug: "at-the-sea-side", title: "At the Sea-Side", author: "Robert Louis Stevenson", kind: "poem", src: "rls", heading: "AT THE SEA-SIDE" },
  { slug: "time-to-rise", title: "Time to Rise", author: "Robert Louis Stevenson", kind: "poem", src: "rls", heading: "TIME TO RISE" },
  { slug: "duck-and-the-kangaroo", title: "The Duck and the Kangaroo", author: "Edward Lear", kind: "poem", src: "lear", heading: "THE DUCK AND THE KANGAROO." },
  { slug: "the-lamb", title: "The Lamb", author: "William Blake", kind: "poem", src: "pdb", pdb: ["Blake", "The Lamb"] },
  { slug: "daffodils", title: "Daffodils", author: "William Wordsworth", kind: "poem", src: "pdb", pdb: ["Wordsworth", "I Wandered Lonely"] },
  { slug: "sonnet-116", title: "Sonnet 116", author: "William Shakespeare", kind: "sonnet", src: "pdb", pdb: ["Shakespeare", "Sonnet 116"] },
