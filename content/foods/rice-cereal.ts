...
const riceCereal: Food = {
  slug: "rice-cereal",
  name: "Iron-fortified rice cereal",
  aliases: ["infant rice cereal", "baby rice cereal", "rice porridge cereal"],
  category: "grain",
  minAgeMonths: 6,
  ironRich: true,
  commonAllergen: null,
  chokingRisk: "low",
  nutritionHighlights: [
    "Iron-fortified — the fortification arrives exactly as a baby's iron stores from birth run low around 6 months",
    "Usually fortified with zinc and B vitamins as well",
    "Single-grain rice is bland and gluten-free, which makes it one of the gentlest first cereals",
  ],
  prepSpecs: [
    {
      band: "6-8m",
      form: "Iron-fortified infant rice cereal whisked with breast milk, formula, or water — about 1 tablespoon of cereal to 4–5 tablespoons of liquid — into a smooth, completely lump-free puree that falls slowly off a tilted spoon.",
      passFailTest:
      ...
      prepSteps: [
        "Measure 1 tablespoon of dry fortified rice cereal into a bowl.",
        "Whisk in 4–5 tablespoons of breast milk, formula, or warm water until completely smooth.",
      ...
      commonMistakes: [
        ...
        "Serving rice cereal at every single meal — rotate it with oat and other grains to limit arsenic exposure.",
    ...
    {
      band: "9-12m",
      form: "The same fortified rice cereal mixed noticeably thicker — roughly 1 tablespoon of cereal to 2–3 tablespoons of liquid — so it holds a soft mound on the spoon, with mashed fruit stirred through for texture.",
      passFailTest:
    ...
    {
      band: "12-24m",
      form: "Fortified rice cereal mixed to a thick, spoon-clinging porridge with soft lumps and bite-size pieces of soft fruit folded in, self-fed with a small toddler spoon at family breakfast.",
      passFailTest:
      ...
      prepSteps: [
        "Mix the cereal thick, or fold it into regular congee to boost the iron of a family breakfast.",
        "Top with chopped soft fruit and hand over the spoon.",
      ],
      commonMistakes: [
        "Letting rice cereal stay the only grain on the menu — by this age the whole family grain rotation is open.",
      ],
      cutDiagram: "mash",
      media: [],
    },
  ...
  firstFoodPick: true,
  flavorPairings: ["banana", "pear", "prunes", "sweet-potato"],
  watchOuts: [
    "Rice takes up more arsenic from soil and water than other grains, so the FDA and AAP advise variety: rotate rice cereal with oat, barley, and multigrain cereals instead of serving it as the only cereal.",
  ],
  tips: [
    ...
    "Rotate grains across the week — rice cereal one day, oat or farina the next — to keep arsenic exposure low without giving up the iron.",
    "Whisk the liquid in gradually rather than dumping it all at once — that is the difference between silky and lumpy.",
  ],
  sources: [SOURCES.wicGuide, SOURCES.cdcFoodsAndDrinks, SOURCES.fdaArsenic, SOURCES.aapStartingSolids],
  nutrients: ["iron"],
  servingGuidance: [
    {
      band: "6-8m",
      ...
      frequency: "Fine as a regular iron source — just rotate it with oat and other grains across the week.",
    },
    {
      band: "9-12m",
      typicalAmount:
